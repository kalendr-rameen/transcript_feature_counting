...
intron_lenght_after_PTC_table = pd.read_csv('Scripts/covar_count/intron_lenght_sum/intron_sum_after_PTC_all_transcript.txt', sep='\t', header=None, names=['Transcript_ID','intron_lenght_after_PTC','strand'])
...
table_unite.rename({'psi_bin_col':'deltaPSI_бин', 'intron_lenght_after_PTC':'длина_интрона_после_стоп_кодона', 'KD':'нокаут'}, axis=1, inplace=True)
...
def annotate(data, **kws):
    ...
    v_1 = data[data['deltaPSI_бин'] == interval_1]['длина_интрона_после_стоп_кодона'].values
    v_2 = data[data['deltaPSI_бин'] == interval_2]['длина_интрона_после_стоп_кодона'].values
    v_3 = data[data['deltaPSI_бин'] == interval_3]['длина_интрона_после_стоп_кодона'].values
...
s = sns.catplot(
    data=table_unite, x='длина_интрона_после_стоп_кодона', y='deltaPSI_бин',
...
s.savefig('длина_интрона_после_стоп_кодона.png')