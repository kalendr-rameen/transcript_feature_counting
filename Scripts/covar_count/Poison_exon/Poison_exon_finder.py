...
for index, i in intersect.iterrows():
    ...
    #!!!!print(numpy.isnan(coords_left).any(), numpy.isnan(coords_right).any())
    #print(gene_name)
    ...
    #print(len(transcript_ID_by_gene))
    
    #sel_exons_by_gene = annotation[(annotation[annotation.columns['gene_name']] == gene_name)]
    #print(sel_exons_by_gene)                                
