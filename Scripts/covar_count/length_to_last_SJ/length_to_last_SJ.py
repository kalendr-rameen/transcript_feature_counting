...
#PBS -d /home/rameen/Covariates/length_to_last_SJ
...
def lenght_to_last_SJ_all(exons_df,strand,PTC_start,PTC_end,exon_contain_PTC_start,exon_contain_PTC_end, ID_transcript):
    ...
    if exon_index_contain_PTC < exons_df.shape[0] - 1:
        ...
        exons_after_PTC_df = exons_df[exon_index_contain_PTC + 1:exons_df.shape[0] - 1]
...
for index, i in intersect.iterrows():
    file_for_write = open('./length_to_last_SJ.txt','a')
    ID_transcript = i[9]
    #print(ID_transcript)
    strand = i[5]
    PTC_start=i[11]
    ...
    lenght = lenght_to_last_SJ_all(sel_exons,strand,PTC_start,PTC_end,exon_contain_PTC_start,exon_contain_PTC_end, ID_transcript)
